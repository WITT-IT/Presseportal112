...
export default function RemoveFromMediaShareButton({
  shareId,
  postId,
}: {
  shareId: string;
  ...
  async function handleClick() {
    ...
    await fetch('/api/intern/media-shares/assign', {
      ...
      body: JSON.stringify({ shareId, postId, action: 'remove' }),
    });
    setBusy(false);
    router.refresh();
  }
  ...
  return (
    <button
      ...
      onClick={handleClick}
      disabled={busy}
      aria-label="Aus Freigabe entfernen"
      title="Aus Freigabe entfernen"
